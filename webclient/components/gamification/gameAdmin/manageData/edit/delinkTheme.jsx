...
export default class DelinkTheme extends React.Component {
  constructor() {
    super();
    this.state = {
      domain: [],
        ...
        <Grid>
          <Grid.Row>
            ...
            <Grid.Column width={14}>
              <p style={{fontSize: '16px', fontFamily: 'arial'}}><b>Remove Category-Theme Link</b></p>
              <Form>
                <Form.Field>
                  <label>
                    <p style={{fontSize: '14px', fontFamily: 'arial'}}>Category</p>
                  </label>
                  <Dropdown onChange={this.updatesearchQueryDomain.bind(this)} placeholder='Select the Category to be modified' fluid search selection options={this.state.domain} />
                </Form.Field>
                <Form.Field>
                  <label>
                    <p style={{fontSize: '14px', fontFamily: 'arial'}}>Theme</p>
                  </label>
                  <Dropdown onChange={this.updatesearchQueryScenario.bind(this)} value={this.state.selectedAccount} placeholder='Select Theme to be delinked to Category' fluid multiple search selection options={this.state.scenario}/>
                </Form.Field>
              </Form>
              <Grid.Column width={8}>
