...
export default class AddTheme extends React.Component {
  ...
  checkForonlyAlphabetsForNameAlert() {
    this.refs.asd.error(
      'Only alphabets allowed in Theme name',
      '', {
        timeOut: 3000,
        extendedTimeOut: 3000
      }
        ...
        <Grid>
          <Grid.Row>
            ...
            <Grid.Column width={14}>
              <p style={{fontSize: '16px', fontFamily: 'arial'}}><b>Add new theme</b></p>
              <Form>
                <Form.Field>
                  <label>
                    <p style={{fontSize: '14px', fontFamily: 'arial'}}>Name</p>
                  </label>
                  <input autoComplete='off' type='text' ref='scenarioName' placeholder='Name of the theme' required/>
                </Form.Field>
                <Form.Field>
                  <label>
                    <p style={{fontSize: '14px', fontFamily: 'arial'}}>Sequence</p>
                  </label>
                  <input autoComplete='off' type='text' ref='Sequence' placeholder='Sequence' required/>
                </Form.Field>
                {/* <Form.Field>
                  <label>
                ...
                {/* <Form.Field>
                  ...
                  <input autoComplete='off' type='number' ref='negScore' required placeholder='Sequence' required/>
                </Form.Field> */}
              </Form>
